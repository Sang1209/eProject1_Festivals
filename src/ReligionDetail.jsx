    ...
    return (
        <>
            ...
            <div className="religion-content" >
                ...
                <img src={religion.pic2} width={'70%'} style={{ display: 'block', margin: 'auto' }} alt="" />
                <p style={{ width: '80%', margin: '20px auto 20px auto', textAlign: 'justify' }}>{religion.content2}</p>
                <br />
                <p style={{ width: '80%', margin: '20px auto 20px auto', textAlign: 'justify' }}>{religion.content1}</p>
                <img src={religion.pic2a} width={'70%'} style={{ display: 'block', margin: 'auto' }} alt="" />
                <p style={{ width: '80%', margin: '20px auto 20px auto', textAlign: 'justify' }}>{religion.content2}</p>
                <div className="rd-namefest">
                ...
                <img src={religion.pic3} width={'70%'} style={{ display: 'block', margin: 'auto' }} alt="" />
                <br />
                <p style={{ width: '80%', margin: '20px auto 20px auto', textAlign: 'justify' }}>{religion.content3}</p>
                <img src={religion.pic3a} width={'70%'} style={{ display: 'block', margin: 'auto' }} alt="" />
                <div className="rd-namefest">
                ...
                <img src={religion.pic4} width={'70%'} style={{ display: 'block', margin: 'auto' }} alt="" />
                <br />
                <p style={{ width: '80%', margin: '20px auto 20px auto', textAlign: 'justify' }}>{religion.content4}</p>
                <img src={religion.pic4a} width={'70%'} style={{ display: 'block', margin: 'auto' }} alt="" />
